    ...
    public class AutoresController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Autor != null ? 
                          ...
                          Problem("Entity set 'BibliotecaContext.Autor'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeAutor,Email")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeAutor,Email")] Autor autor)
        {
            if (id != autor.Id)
            {
                return NotFound();
